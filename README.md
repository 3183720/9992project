...
## Description   
modified implementation of AGE for few-shot image generation. Code is modified from [AGE]([https://github.com/eladrich/pixel2style2pixel.git](https://github.com/UniBester/AGE.git]).
